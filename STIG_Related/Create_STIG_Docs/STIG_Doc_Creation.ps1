...
##################################
#Load XML
[xml]$CKLFile = Get-Content -Path 'C:\Temp\STIGCKLS\server.ckl'

#Get the Open Findings
$OPENFINDINGS = $CKLFile.CHECKLIST.STIGS.iSTIG.VULN | ? {$_.STATUS -match "Open"}

#Load PDF Reader DLL
[System.Reflection.Assembly]::LoadFrom('C:\Users\aaroncole\Create_STIG_Docs\itextsharp.dll') | Out-Null 

#Blank PDF Documentable Form
$blank_form = 'C:\Users\aaroncole\Create_STIG_Docs\BlankForm.pdf' 
...
$outputfile = "C:\Temp\STIGCKLS\Documentables_To_Be_Signed\$VULID.pdf"
